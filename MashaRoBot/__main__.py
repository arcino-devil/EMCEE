...
PM_START_TEXT = """
HeY❥ {message.from_user.first_name} Wa†รuƤ Mℽ Nคϻe i͢͢͢ຮ Michͥสeͣlͫ
ι αм α gяσυρ мαηαgємєηт вσт, нєяє тσ нєℓρ уσυ gєт αяσυη∂ αη∂ кєєρ тнє σя∂єя ιη уσυя gяσυρѕ! ι нανє ℓσтѕ σƒ нαη∂у ƒєαтυяєѕ, ѕυ¢н αѕ ƒℓσσ∂ ¢σηтяσℓ, α ωαяηιηg ѕуѕтєм, α ησтє кєєριηg ѕуѕтєм, αη∂ єνєη ρяє∂єтєямιηє∂ яєρℓιєѕ ση ¢єятαιη кєуωσя∂ѕ. [.](https://telegra.ph/file/f3b712516d17727ff3724.jpg)
"""
...
buttons = [
    ...
    [
        InlineKeyboardButton(
            text="🔥Owner🔥", url="http://t.me/DesiNobita"),
        InlineKeyboardButton(
            text="⚜co-owner⚜", url="https://t.me/TheRiZoeL"),
    ],
    [  
        InlineKeyboardButton(text="❗OFFICIAL GROUP❕", url="https://t.me/cartoons_007"),
    ], 
...
HELP_STRINGS = """
༆*ƒєαтυяєѕ σƒ Michͥสeͣlͫ αяє*༆
꧁*¢нє¢к αℓℓ тнє вυттσηѕ тσ єχρℓσяє тнє ƒєαтυяєѕ*꧂
